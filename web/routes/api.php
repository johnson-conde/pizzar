...
Route::get('/pizzaria/{pizzaria_id}', function(String $pizzaria_id){
   return Pizzaria::find($pizzaria_id);
});
...
Route::post('/encomendar', function(Request $request){
  ...
  $validator = Validator::make(
               $request->only(['pizzaria_id','usuario_id',
               'pontos_de_entrega_id', 'metodo_de_pagamento_id',
               'comentario']), $rules);
  if($validator->fails()){
