<!-- TOP BAR -->
		<div class="top-bar navbar-fixed-top">
			<div class="container">
				<div class="clearfix">
					<a href="#" class="pull-left toggle-sidebar-collapse">
            <i class="fa fa-bars"></i>
          </a>
					<!-- logo -->
					<div class="pull-left left logo">
						<a href="">
              <img src="/img/kingadmin-logo-white.png" alt="KingAdmin - Admin Dashboard" />
            </a>
						<h1 class="sr-only">Pizzar Admin Dashboard</h1>
					</div>
					<!-- end logo -->
					<div class="pull-right right">
						...
						<div class="searchbox">
							<div id="tour-searchbox" class="input-group">
								<input type="search" class="form-control" placeholder="o que procuras?...">
											...
											<ul class="dropdown-menu" role="menu">
													...
													<a href="#">
														<div class="media">
															<div class="media-left">
																<img class="media-object" src="/img/user1.png" alt="Antonio">
															</div>
												...
												<li class="inbox-item unread clearfix">
													<a href="#">
														<div class="media">
															<div class="media-left">
																<img class="media-object" src="/img/user2.png" alt="Antonio">
															</div>
															<div class="media-body">
												...
												<li class="inbox-item clearfix">
													<a href="#">
														<div class="media">
															<div class="media-left">
																<img class="media-object" src="/img/user4.png" alt="Antonio">
															</div>
															<div class="media-body">
												...
												<li class="inbox-item clearfix">
													<a href="#">
														<div class="media">
															<div class="media-left">
																<img class="media-object" src="/img/user5.png" alt="Antonio">
															</div>
															<div class="media-body">
							...
							<div class="logged-user">
								<div class="btn-group">
									<a href="#" class="btn btn-link dropdown-toggle" data-toggle="dropdown">
										...
										<span class="name"> {{Auth::guard("pizzaria")->user()->nome}}</span>
